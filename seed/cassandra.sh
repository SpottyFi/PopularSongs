...
cqlsh -e "COPY spottyfi.artists(artist_id, album_id, artist_name, album_name, album_image, published_year, song_name, song_streams, song_length, song_popularity) FROM '${SEED_FILE}' WITH HEADER=TRUE AND DELIMITER='|';"
